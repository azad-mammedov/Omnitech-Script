...
input_file = input('Oxuyacagimiz faylin adini qeyd edin:') or 'oper1.xlsx'
output_file = input('Yazacagimiz faylin adini qeyd edin:') or 'results_for_oper1.xlsx'
...
def make_data(row , *args, **kwargs) -> dict:
    ...
    long_id = row[9].value
    short_id  = row[8].value
    refund_document_number = row[7].value
    ...
    new_data['requestData']['tokenData']['parameters']['data']['vatAmounts'][0].pop('vatResult')
    new_data['requestData']['tokenData']['parameters']['data'].pop('docType')
    new_data['requestData']['tokenData']['parameters']['data'].pop('docNumber')
    new_data['requestData']['tokenData']['parameters']['data'].pop("cashboxTaxNumber")
    new_data['requestData']['tokenData']['parameters']['data'].pop("createdAtUtc")
